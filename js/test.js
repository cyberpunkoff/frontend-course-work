const DATA = [
  {
    question:
      "Какой из следующих терминов обозначает нереляционные базы данных?",
    answers: [
  ...
  {
    question:
      "Какая из нижеперечисленных СУБД предназначена для обработки временных рядов и событий?",
    answers: [
  ...
  {
    question:
      "В какой категории СУБД можно выделить ключ-значение (key-value) хранилища?",
    answers: [
  ...
  {
    question:
      "Какая из следующих СУБД часто используется для кэширования данных?",
    answers: [
  ...
  {
    question:
      "Какой тип нереляционных СУБД ориентирован на обработку больших объемов данных в распределенной среде?",
    answers: [
  ...
  {
    question:
      "Какая из нижеперечисленных СУБД предоставляет язык запросов Gremlin для работы с графовыми данными?",
    answers: [
  ...
  {
    question:
      "Какое из утверждений характеризует преимущества нереляционных СУБД?",
    answers: [
